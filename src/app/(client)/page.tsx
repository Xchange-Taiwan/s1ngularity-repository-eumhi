    ...
    <>
      <div className="m-auto h-[670px] md:h-[735px] relative w-full flex items-center justify-center xl:max-w-screen-2xl">
        <div className="flex flex-col items-center md:w-[440px] xl:w-[600px]">
          <p className="text-midnight-blue text-center text-5xl mb-5 font-bold tracking-[0.17em]">交流讓<br className="md:hidden" />改變發生</p>
          <p className="text-black text-2xl font-bold text-center">Find your Mentor/Mentee to<br className="md:hidden" /> build up connections, break up <br className="md:hidden" />limits.</p>
        </div>
        ...
        <div className="bg-blue md:bg-orange w-24 h-[452px] rotate-45 rounded-[124px] absolute top-[130px] md:top-[235px] left-[-140px] xl:left-[-20px] overflow-hidden z-10"></div>
        <Image src={landingPage_3} className="w-36 rounded-full top-[140px] left-[-300px] xl:left-[-70px] absolute" alt="1" />
        <div className="bg-yellow w-24 h-[181px] rotate-45 rounded-[124px] absolute top-[600px] left-[-500px] xl:left-[50px] overflow-hidden z-10"></div>
        <div className="bg-blue w-24 h-[439px] rotate-45 rounded-[124px] absolute top-[720px] left-[-500px] xl:left-[-200px] overflow-hidden z-10"></div>
        <div className="bg-coral-pink w-24 h-[452px] rotate-45 rounded-[124px] absolute top-[250px] left-[-500px] xl:left-[-300px] overflow-hidden z-10"></div>
        <div className="bg-purple w-24 h-[452px] rotate-45 rounded-[124px] absolute top-[580px] left-[-500px] xl:left-[-380px] overflow-hidden z-10"></div>
      </div>
      ...
      <div className="contents xl:block md:m-auto md:w-[930px] md:h-[1100px] xl:h-[790px] relative">
        <div className="flex mt-[70px] mb-[50px] xl:mt-7 xl:mb-[130px] items-center flex-col xl:flex-row">
          ...
          <div className="flex flex-wrap md:mt-10 w-[420px] p-[30px] md:p-0 flex-row xl:w-full xl:flex-col xl:pl-[62px] m-auto">
            ...
            <p className="text-black text-xl">聚集多種專業職能的資深前輩，分享產業洞見、職涯心法，協助建構更多元的角度與觀點。不論你是剛開始、還未開始，一起陪你把職涯走得更遠更寬闊。</p>
          </div>
        </div>
        <div className="flex mt-7 mb-[50px] md:mb-[130px] items-center flex-col-reverse xl:flex-row">
          <div className="flex flex-wrap md:mt-10 w-[420px] p-[30px] flex-row xl:w-full xl:flex-col xl:pr-[62px] m-auto">
            <p className="text-midnight-blue text-2xl mb-5 font-bold">透過 X-Talent 展開深度交流</p>
            <p className="text-black text-xl">透過 X-Talent 立即安排與 Mentor 一對一的深度交流，讓你在尋求職涯建議、建立人脈上得到最直接的回饋。</p>
          </div>
          <Image src={landingPage_5} className="w-[420px]" alt="1" />
        </div>
      </div>
      <div className="bg-dark-blue flex h-[907px] md:h-[425px] xl:h-[557px] w-full">
        <div className="relative m-auto h-full md:w-[767px] flex flex-col justify-center md:items-center md:flex-wrap md:flex-row xl:w-[1280px]">
          ...
          <div className="bg-yellow my-[15px] flex justify-center items-center flex-col rounded-[124px] w-[223px] h-[53px] xl:w-[292px] xl:h-[100px] xl:absolute xl:left-[521px] xl:top-[86px]">
            <p className="text-[#1D1D11] font-bold">Product Management</p>
            <p className="text-[#1D1D11] font-light hidden xl:block">103 Mentors</p>
          </div>
          <div className="bg-pink my-[15px] flex justify-center items-center flex-col md:mb-[50px] rounded-[124px] w-[157px] h-[53px] xl:w-[224px] xl:h-[100px] xl:absolute xl:left-[250px] xl:top-[386px]">
            <p className="text-[#1D1D11] font-bold">Data Science</p>
            <p className="text-[#1D1D11] font-light hidden xl:block">103 Mentors</p>
          </div>
          <div className="bg-blue my-[15px] flex justify-center items-center flex-col md:mb-[50px] md:mx-[30px] rounded-[124px] w-[256px] h-[53px] xl:mx-0 xl:w-[313px] xl:h-[100px] xl:absolute xl:right-[404px] xl:top-[386px]">
            <p className="text-[#1D1D11] font-bold">Software Development</p>
            <p className="text-[#1D1D11] font-light hidden xl:block">103 Mentors</p>
          </div>
          <div className="bg-purple my-[15px] flex justify-center items-center flex-col md:mb-[50px] rounded-[124px] w-[203px] h-[53px] xl:w-[270px] xl:h-[99px] xl:absolute xl:right-[144px] xl:top-[236px]">
        ...
        <div className="w-[1280px] m-auto h-full flex flex-col justify-center items-center">
          <div className="flex">
            ...
            <div className="xl:ml-[78px]">
              <p className="text-midnight-blue text-center xl:text-start font-bold text-2xl mt-1">成為 Mentor，你將可以‧‧‧</p>
          ...
          <div className="flex mt-[70px] md:mt-[116px]">
            ...
            <div className="xl:ml-[78px]">
              <p className="text-midnight-blue text-center xl:text-start font-bold text-2xl mt-1">成為 Mentee，你將可以‧‧‧</p>
              <div className="flex flex-col md:flex-row mt-[65px] md:items-center">
                <div className="flex mb-[60px] md:m-0 xl:w-[180px] md:flex-col items-center">
                ...
                <div className="mb-[60px] md:m-0 flex xl:w-[180px] md:flex-col items-center md:ml-[80px]">
                  ...
                  <div className="ml-[35px] md:mt-[34px] md:ml-0 flex flex-col md:items-center justify-center">
                    <p className="text-black font-medium">與經驗豐富的 Mentor</p>
                    <p className="text-black font-medium">互動獲取第一手職涯秘笈</p>
                  </div>
                </div>
                <div className="flex xl:w-[180px] md:flex-col items-center md:ml-[80px]">
                  <Image className="ml-[45px] md:m-0" src={landingPage_icon_6} alt="1" />
                  <div className="ml-[30px] md:mt-[34px] md:ml-0 flex flex-col md:items-center">
                    <p className="text-black font-medium">學習更多學校沒教的事</p>
      ...
      <div className="flex items-center justify-center h-[215px] w-f">
        <button className="bg-teal-blue w-[262px] h-[80px] md:w-[415px] md:h-[51px] rounded-md text-white text-xl font-bold tracking-[0.09em]">加入排隊名單，<br className="md:hidden" />搶先成為 X-Talent →</button>
      </div>
    </>
  )
}
